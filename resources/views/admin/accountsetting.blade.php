                                ...
                                <div class="shadow sm:rounded-md sm:overflow-hidden">
                                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                        <div class="col-span-6 sm:col-span-4">
                                            <label for="username"
                                                class="block text-sm font-medium text-gray-700">Email/Username</label>
                                            <input type="text" name="username" id="username"
                                                value="{{ $account->email }}" placeholder="Masukkan Username atau Email"
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            ...
                                            <input type="password" id="current_password" name="current_password"
                                                placeholder="Masukkan Password Lama" onchange="checkCurrentPassword(); isEmptyCurrentPassword()"
                                                class="mt-1 focus:ring-lightBlue-500 focus:border-lightBlue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            <span id="wrong_indicator" class="hidden ml-1 text-xs text-red-600">Password
                                                Salah</span>
                                        </div>
                                        <div class="col-span-6 sm:col-span-4">
