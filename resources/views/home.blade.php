    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 backdrop" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="#">
            <div class="text-warning">Sin</div>
            <div class="text-1000">tevo</div>
          </a>
            ...
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
                {{-- <li class="nav-item">
                    <form class="form-search" role="search">
                        ...
                        <input class="input-search" id="search" type="search" placeholder="Search..." autofocus required />
                ...
                <li class="nav-item"><a class="nav-link fw-medium" href="#features">Key Features</a></li>
                <li class="nav-item"><a class="nav-link fw-medium" href="#pricing">Pricing</a></li>
                <li class="nav-item"><a class="nav-link fw-medium" href="#testimonial">Testimonial</a></li>
      ...
      <section class="py-0">
        ...
        <div class="container position-relative">
          <div class="row align-items-center py-8">
            <div class="col-md-5 col-lg-6 order-md-1 text-center text-md-end"><img class="img-fluid" src="assets/images/icon.png" width="350" alt="" /></div>
