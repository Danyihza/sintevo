<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
    <div
        ...
        <ul class="flex items-center flex-shrink-0 space-x-6">
            ...
            <!-- Notifications menu -->
            <li class="relative">
                <button class="relative align-middle rounded-md focus:outline-none focus:shadow-outline-lightBlue"
            ...
            <li class="relative">
                <button class="align-middle rounded-full focus:shadow-outline-lightBlue focus:outline-none"
                    ...
                    aria-haspopup="true">
                    <img id="topbar-image" class="object-cover w-8 h-8 rounded-full" src="{{ asset('/assets/img/tenant') }}/default.png"
