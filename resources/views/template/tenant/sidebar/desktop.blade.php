        ...
        <ul>
            ...
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-semibold {{ $title == 'kelulusan' ? 'text-gray-800' : '' }} transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    ...
                    <span class="ml-4">Berkas & Kelulusan</span>
                </a>
            </li>
            <li class="relative px-6 py-3">
                @if($title == 'faq')
                    <span class="absolute inset-y-0 left-0 w-1 bg-lightBlue-600 rounded-tr-lg rounded-br-lg"
                        aria-hidden="true"></span>
                @endif
                <a class="inline-flex items-center w-full text-sm font-semibold {{ $title == 'faq' ? 'text-gray-800' : '' }} transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    href="{{ route('user.faqView') }}">
                    ...
                    <span class="ml-4">Frequently Asked Questions (FAQ)</span>
                </a>
            </li>
        </ul>
        <div class="px-6 my-6">
