                ...
                <div class="container px-6 mx-auto grid">
                    ...
                    <div class="md:grid md:gap-6 mb-8">
                        <div class="mt-5 md:mt-0 md:col-span-2">
                            <form action="{{ route('user.monevTambah') }}/pemasaran" method="POST" enctype="multipart/form-data" id="formTambahPemasaran">
                                @csrf
