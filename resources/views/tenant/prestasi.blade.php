                ...
                <div class="container px-6 mx-auto grid">
                    ...
                    <div class="md:grid md:gap-6 mb-8">
                        <div class="mt-5 md:mt-0 md:col-span-2">
                            <form action="/tenant/prestasi/tambah" method="POST" enctype="multipart/form-data" id="formTambahProduk">
                                @csrf
                                    ...
                                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                        ...
                                        <div x-data="app()" x-init="[initDate(), getNoOfDays()]" class="container mx-auto ">
                                            <div class="mb-5 w-full">
                                                ...
                                                <div class="relative">
                                                    ...
                                                    <input type="text" x-on:click="showDatepicker = !showDatepicker" x-model="datepickerValue" x-on:keydown.escape="showDatepicker = false" class="shadow-sm focus:ring-lightBlue-500 focus:border-lightBlue-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Select date" readonly />
                                        ...
                                        <div class="grid grid-cols-3 gap-6">
                                            <div class="col-span-6 sm:col-span-3">
                                                <label for="jenis_kegiatan" class="block text-sm font-medium text-gray-700">Jenis
                                                    Kegiatan</label>
                                                <select id="jenis_kegiatan" name="jenis_kegiatan" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-lightBlue-500 focus:border-lightBlue-500 sm:text-sm">
                                        ...
                                        <div class="grid grid-cols-3 gap-6">
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <select id="prestasi" name="prestasi" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-lightBlue-500 focus:border-lightBlue-500 sm:text-sm">
                                        ...
                                        <div class="grid grid-cols-3 gap-6">
                                            <div class="col-span-6 sm:col-span-3">
                                                <label for="tingkat_prestasi" class="block text-sm font-medium text-gray-700">Tingkat
                                                    Prestasi</label>
                                                <select id="tingkat_prestasi" name="tingkat_prestasi" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-lightBlue-500 focus:border-lightBlue-500 sm:text-sm">
