                ...
                <div class="container px-6 mx-auto grid">
                    ...
                    <div class="md:grid md:gap-6 mb-8">
                        <div class="mt-5 md:mt-0 md:col-span-2">
                            <form action="/tenant/monev/tambah/produk" method="POST" enctype="multipart/form-data" id="formTambahProduk">
                                @csrf
                                    ...
                                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                            ...
                                            <div class="grid grid-cols-3 gap-6">
                                                <div class="col-span-6 sm:col-span-3">
                                                    <label for="jenis_kegiatan"
                                                        class="block text-sm font-medium text-gray-700">Jenis Kegiatan</label>
                                            ...
                                            <div class="grid grid-cols-3 gap-6">
                                                <div class="col-span-6 sm:col-span-3">
                                                    <label for="tingkat_prestasi"
                                                        class="block text-sm font-medium text-gray-700">Tingkat Prestasi</label>
                                            ...
                                            <div class="col-span-6 sm:col-span-4">
                                                ...
                                                <label class="mt-1 flex rounded-md shadow-sm cursor-pointer">
                                                    ...
                                                    class="focus:ring-lightBlue-500 focus:border-lightBlue-500 flex-1 block w-full rounded-none rounded-l-md sm:text-sm border-gray-300"
                                                    placeholder="Klik Browse untuk menambahkan file"
                                                    disabled>
                                                    <span
