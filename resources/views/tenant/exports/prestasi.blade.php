<table>
    <thead>
        <tr>
            ...
            <th align="center" style="background-color: #92D050; border: 1px solid #000000;">Kegiatan</th>
            <th align="center" style="background-color: #92D050; border: 1px solid #000000;">Prestasi</th>
            <th align="center" style="background-color: #92D050; border: 1px solid #000000;">File</th>
            <th align="center" style="background-color: #92D050; border: 1px solid #000000;">Tingkat Prestasi</th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td align="center" style="border: 1px solid #000000;">{{ $pres->file ? 'Ada' : 'Tidak Ada'}}</td>
